...
struct FVM_API CellConnectivity {
 ...
 */
FVM_API PartitionMesh load_partition_mesh(const std::string& filepath);
 ...
 * @return Loaded PartitionMesh object
 */
FVM_API PartitionMesh load_partition_for_rank(const std::string& mesh_dir, int rank);

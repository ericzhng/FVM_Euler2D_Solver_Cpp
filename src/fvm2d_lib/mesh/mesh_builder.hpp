...
namespace fvm2d
{
    ...
    struct FVM_API BoundaryFaceData
    {
     ...
     */
    FVM_API PartitionInfo load_partition_info(const std::string &json_path);
     ...
     */
    FVM_API BoundaryFaceData load_boundary_faces(const std::string &boundaries_path);
     ...
     */
    FVM_API PartitionMesh build_partition_mesh(
     ...
     * @return Fully constructed PartitionMesh
     */
    FVM_API PartitionMesh load_partition_mesh_from_dir(const std::string &mesh_dir, int rank);
